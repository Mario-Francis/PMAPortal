...
namespace PMAPortal.Web.Migrations
{
    ...
    [Migration("20220323134201_Modify_Feedback_Table")]
    partial class Modify_Feedback_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMAPortal.Web.Models.CustomerFeedback", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PMAPortal.Web.Models.InstallationLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PMAPortal.Web.Models.CustomerFeedback", b =>
                {
                    b.HasOne("PMAPortal.Web.Models.Applicant", null)
                        .WithMany("ApplicantFeedbacks")
                        .HasForeignKey("ApplicantId");

                    b.HasOne("PMAPortal.Web.Models.Application", null)
                        .WithMany("ApplicantFeedbacks")
                        .HasForeignKey("ApplicationId");
            ...
            modelBuilder.Entity("PMAPortal.Web.Models.FeedbackAnswer", b =>
                {
                    b.HasOne("PMAPortal.Web.Models.CustomerFeedback", "ApplicantFeedback")
