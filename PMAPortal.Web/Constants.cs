...
namespace PMAPortal.Web
{
    ...
    public enum ActivityActionType
    {
        ...
        ASSIGN_INSTALLATION_TASK,
        ASSIGN_INSTALLATION_TASKS,
        REASSIGN_INSTALLATION_TASK,
        REASSIGN_INSTALLATION_TASKS,
        UNASSIGN_INSTALLATION_TASK,
        UNASSIGN_INSTALLATION_TASKS,
        SCHEDULE_INSTALLATION,
        SCHEDULE_INSTALLATIONS,
        UPDATE_INSTALLATION_METER_INFO,
        UPLOAD_INSTALLATION_IMAGE,
        DELETE_INSTALLATION_IMAGE,
        COMPLETE_INSTALLATION,
        REJECT_INSTALLATION,
        DISCO_APPROVE_INSTALLATION,
        DISCO_REJECT_INSTALLATION
